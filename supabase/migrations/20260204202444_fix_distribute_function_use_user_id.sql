/*
  # Fix distribute_daily_points() to use user_id column

  1. Changes
    - Update function to use user_id instead of id for user_profiles
    - All references to id changed to user_id
    - Function logic remains the same, just column name fix

  2. Notes
    - The user_profiles table uses user_id as the primary key
    - This is a critical fix for distribution to work
*/
...
BEGIN
  ...
  BEGIN
    FOR v_current_batch IN 1..v_total_batches LOOP
      ...
      WHERE user_id = ANY(v_batch_user_ids);
