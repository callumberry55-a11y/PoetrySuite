    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 sm:p-6 text-white">
          ...
          <div className="text-xs sm:text-sm opacity-90 mt-1 break-words">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-4 sm:p-6 text-white sm:col-span-2 lg:col-span-1">
          <div className="flex items-center gap-3 mb-2">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
        ...
        <div className="overflow-x-auto overflow-y-visible -mx-2 px-2">
          <div className="min-w-[600px]">
            <div className="flex items-end justify-between gap-1 sm:gap-2 h-64 px-2 pb-16">
              {MONTHS.map((month, index) => {
                ...
                return (
                  <div key={month} className="flex-1 flex flex-col items-center gap-2 min-w-0">
                    ...
                    <div className="relative w-full flex items-end justify-center" style={{ height: `${maxBarHeight}px` }}>
                      ...
                      {isCurrentMonth && (
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 z-10">
                          <div className="bg-green-600 text-white text-xs px-2 py-1 rounded-full shadow-lg whitespace-nowrap">
                            Current
                          </div>
                        </div>
                      )}
                    ...
                    {/* Month label */}
                    <div className="text-[10px] sm:text-xs text-gray-600 text-center font-medium whitespace-nowrap transform -rotate-45 origin-top mt-8">
                      {month.slice(0, 3)}
                    </div>
                  </div>
                );
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="space-y-1 sm:space-y-2">
            <div className="text-xs sm:text-sm text-gray-600">Fiscal Year</div>
            <div className="text-lg sm:text-xl font-bold text-gray-900">{budgetData.fiscal_year}</div>
          </div>
          <div className="space-y-1 sm:space-y-2">
          ...
          <div className="space-y-1 sm:space-y-2">
            <div className="text-xs sm:text-sm text-gray-600">Points Allocated</div>
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <div className="text-lg sm:text-xl font-bold text-gray-900">{12 - currentMonth - 1}</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3 sm:gap-4 justify-center text-xs sm:text-sm">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 sm:w-4 sm:h-4 rounded bg-gradient-to-t from-gray-300 to-gray-400 flex-shrink-0"></div>
          <span className="text-gray-600">Past Months</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 sm:w-4 sm:h-4 rounded bg-gradient-to-t from-green-500 to-green-400 flex-shrink-0"></div>
          <span className="text-gray-600">Current Month</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 sm:w-4 sm:h-4 rounded bg-gradient-to-t from-blue-500 to-blue-400 flex-shrink-0"></div>
