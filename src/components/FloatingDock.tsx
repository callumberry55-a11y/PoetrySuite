...
import { AppWindow, Moon, Sun, LogOut, PenLine, Library, Compass, BookOpen, Lightbulb, Settings, Users, User, Zap, Trophy, Target, UsersRound, GraduationCap, Award, ShoppingBag, Shield, Landmark, UserPlus, ListChecks, BookMarked, Feather, Pencil, MessageSquare, FolderHeart, Heart, Timer, Brain, MessagesSquare } from 'lucide-react';
